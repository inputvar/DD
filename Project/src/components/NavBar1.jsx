...
const NavBar1 = () => {
  ...
  return (
    <div className='flex opacity-90 justify-between items-center h-20 mx-0 px-6 text-purple-600 absolute inset-0 top-0 left-0 z-50 bg-black'>
      <h1>
        <Link to="/" className='text-5xl font-bold Trocchi left-4 m-5 ml-5'>
          UDI
        </Link>
      </h1>
